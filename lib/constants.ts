...
export const STAGE_COLORS: Record<string, { bg: string; text: string; border: string }> = {
  ...
  'Solution In Progress': { bg: '#ede9fe', text: '#7c3aed', border: '#c4b5fd' },
  'Design Team Acceptance': { bg: '#fce7f3', text: '#db2777', border: '#f9a8d4' },
  'Design In Progress': { bg: '#fff7ed', text: '#ea580c', border: '#fdba74' },
  'Design Approval': { bg: '#fef9c3', text: '#ca8a04', border: '#fde047' },
